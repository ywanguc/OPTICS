function optics_coredistances=optics_coredist_memeff(datafile, MinPts)
% function optics_coredistances=optics_coredist_memeff(datafile, MinPts) calculates the
% core-distance of points in datafile specified by MinPts, with efficient memory use (but it takes longer time). It returns a
